...
<body>
	...
	<form name=writeform method=post action="write_ok1.jsp">
		<table class="table">
		<tbody>
	     <tr>
	       <th>제목</th>
	     <td><input type="text" placeholder="제목을 입력하s세요. " name="title" class="form-control"/></td>
	     </tr>
	     <tr>
	       <th>이름</th>
	     <td><input type="text" placeholder="제목을 입력하세요. " name="name" class="form-control"/></td>
			...
			<tr>
			<td colspan="2">
			<div class="form-write" onclick="javascript:location.href='list1.jsp'">목록으로</div>
