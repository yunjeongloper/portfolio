...
<%
	...
	try {
		...
		String sqlList = "SELECT NUM, USERNAME, TITLE, HIT from board2 order by NUM DESC";
...
<td>&nbsp;</td>
	<td><%=idx %></td>
	<td align="left"><a href="view2.jsp?idx=<%=idx%>"
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr align="center">
   <td><div class="form-submit mtop-30" onclick="window.location='write2.jsp'">WRITE MY LETTER</div>
  </tr>
</table>
</body>
</html>
